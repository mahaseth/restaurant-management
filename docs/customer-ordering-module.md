...
**Ops / AI:** Embeddings and scripts: **[Scripts](scripts.md)**; env overview: **[Environment](environment.md)** and **`backend/.env.example`** (Supabase URI, OpenAI/Azure, optional `MENU_RAG_DEBUG`).
